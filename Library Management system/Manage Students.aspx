<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageStudents.aspx.cs" Inherits="Library_Management_System.ManageStudents" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="form-container">
            ...
            <asp:Button ID="btnSave" runat="server" Text="Add / Update Student" OnClick="btnSave_Click" />
        </div>
        <asp:GridView ID="GridViewStudents" runat="server" CssClass="grid" AutoGenerateColumns="False">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Actions">
                    <ItemTemplate>
                        <asp:Button ID="btnEdit" runat="server" Text="Edit" CssClass="action-btn edit-btn" CommandArgument='<%# Eval("StudentID") %>' OnClick="btnEdit_Click" />
                        <asp:Button ID="btnDelete" runat="server" Text="Delete" CssClass="action-btn delete-btn" CommandArgument='<%# Eval("StudentID") %>' OnClick="btnDelete_Click" />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
