...
{
    public partial class ChangePassword : StudentPageBase
    {
        ...
        protected void btnChangePassword_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = Connection.GetConnection())
            {
                ...
                SqlCommand cmdGet = new SqlCommand("SELECT Password FROM Students WHERE StudentID=@ID", con);
                cmdGet.Parameters.AddWithValue("@ID", studentId);
                ...
                SqlCommand cmdUpdate = new SqlCommand("UPDATE Students SET Password=@Password WHERE StudentID=@ID", con);
